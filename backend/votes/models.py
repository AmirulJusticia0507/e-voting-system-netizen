...
class Vote(models.Model):
    ...
    encrypted_choice = models.TextField(blank=True, default="")
    ...
    def verifiable(self) -> bool:
        """True jika seluruh kolom integritas terisi (suara modern)."""
        return bool(self.integrity_hash and self.encrypted_choice and self.nonce)